...
public final class FindMeetingQueryTest {
    ...
    public void justEnoughRoom() {
        ...
        Collection < Event > events = Arrays.asList(
            new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
                Arrays.asList(PERSON_A)),
            new Event("Event 1", TimeRange.fromStartEnd(TIME_0830AM, TIME_0845AM, false),
                Arrays.asList(PERSON_B)),
    ...
    public void allOptionalAttendees() {
        Collection < Event > events = Arrays.asList(
            new Event("Event 1", TimeRange.fromStartEnd(TIME_0800AM, TIME_0830AM, false),
                Arrays.asList(PERSON_A)),
            new Event("Event 1", TimeRange.fromStartEnd(TIME_0845AM, TIME_0900AM, false),
                Arrays.asList(PERSON_B)),
            new Event("Event 2", TimeRange.fromStartEnd(TIME_0930AM, TIME_1000AM, false),
                Arrays.asList(PERSON_A)));

        MeetingRequest request =
            new MeetingRequest(Arrays.asList(), DURATION_15_MINUTES);
    ...
    @Test
    public void noFreeTimeAllOptionalAttendees() {
        Collection < Event > events = Arrays.asList(
            new Event("Event 1", TimeRange.fromStartEnd(TimeRange.START_OF_DAY, TIME_0830AM, false),
                Arrays.asList(PERSON_A)),
